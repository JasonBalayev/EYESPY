        ...
        <div className="relative min-h-screen flex flex-col items-center justify-center px-4 text-white z-10">
          ...
          >
            ...
            <p className="text-lg sm:text-xl text-gray-300 mt-4">
              Junior @ Northeastern University actively seeking internships in software engineering and fintech.  
              <br />  
              Open to opportunities for Summer 2024 and beyond.
            </p>
          </motion.div>
          ...
          >
            ...
            <motion.a
              whileHover={{ scale: 1.05 }}
              href="mailto:bennett-harper.c@northeastern.edu"
