      ...
      <Layout>
        <div className="relative min-h-screen flex flex-col items-center justify-center px-4 text-white z-10">
          ...
          >
            ...
            >
              <div className="bg-gradient-to-r from-purple-500 to-purple-700 hover:from-purple-600 hover:to-purple-800 text-white text-md h-12 px-8 flex justify-center items-center rounded-full shadow-lg transition-all duration-300 gap-2">
