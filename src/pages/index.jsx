...
import { FaArrowDown, FaGithub, FaLinkedin, FaCode, FaLaptopCode, FaChartLine, FaTerminal } from "react-icons/fa";
  ...
  return (
    <Layout>
      <div className="relative min-h-screen w-full overflow-y-auto pb-20">
        <AnimatedStars financeMode={false} />
        ...
        >
          <motion.section className="flex flex-col items-center w-full mt-2 sm:mt-4">
            ...
            >
              <div className="absolute -inset-1 rounded-full bg-gradient-to-r from-blue-600 via-blue-500 to-blue-400 animate-spin-slow" />              
              <div className="absolute inset-0 rounded-full bg-gradient-to-r from-blue-600 via-blue-500 to-blue-400 opacity-30 blur-md animate-pulse-slow" />              
              <img
                src={profileImage}
            ...
            <div className="relative w-full text-center">
              <h1 className="relative text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold font-spaceGrotesk tracking-tight">
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 via-blue-400 to-blue-600 [text-shadow:_0_0_30px_rgb(59_130_246_/_0.3)] animate-pulse">
            ...
            <h2 className="text-xl sm:text-2xl md:text-3xl mt-2 text-center text-gray-300 flex items-center justify-center gap-3 font-spaceGrotesk">
              ...
              <TypewriterText
                text="CS + Econ @ Northeastern University"
                delay={1500}
                speed={50}
              />
            </h2>
            ...
            >
              <TypewriterText
                text="Incoming SWE Intern @ Sixth Street | Bridging technology and finance."
                delay={4000}
                speed={30}
              />
            </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 mt-12 w-full max-w-5xl">
              ...
              <FeatureBox
                ...
                description="Applying CS principles to solve complex financial challenges."
                color="blue"
              />
              <FeatureBox
                icon={<FaLaptopCode />}
                title="Full Stack Development"
                description="Creating end-to-end solutions with scalable architectures."
                color="blue"
              />            
            </div>
            ...
            <div className="flex space-x-6 mt-8">
              <a
                href="https://github.com/calebbenharper"
                target="_blank"
              ...
              <a
                href="https://linkedin.com/in/calebbenharper"
                target="_blank"
                rel="noopener noreferrer"
                className="text-blue-400 hover:text-white transition-colors duration-300"
              >
              ...
              <a
                href="https://x.com/calebbenharper"
                target="_blank"
                rel="noopener noreferrer"
                className="text-blue-400 hover:text-white transition-colors duration-300"
              >
...
const FeatureBox = ({ icon, title, description, color = "blue" }) => {
