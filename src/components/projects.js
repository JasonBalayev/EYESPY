export var projects = [
  {
    name: "Portfolio 🔧 (Click here for github)",
    description:
  ...
  {
    name: "Resume LaTeX Generator 📝 (Click here for github)",
    description:
  ...
  {
    name: "LeetCode Solutions (Click here for github)",
    description:
  ...
  {
    name: "Minimax Algorithm Through Tic-Tac-Toe (Click here for github)",
    description:
