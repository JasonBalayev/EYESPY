export var projects = [
  {
    name: "jasonbalayev.dev 🔧 (Public - Click here for github)",
    description:
  ...
  {
    name: "Resume LaTeX Generator 📝 (Public - Click here for github)",
    description:
  ...
  {
    name: "Jason's AI Space 🤖 (Public - Click here for github)",
    description:
  ...
  {
    name: "Northeastern Electric Racing 🏎️ (Public - Click here for github)",
    description:
  ...
  {
    name: "AI-Convex 🤖 (Public - Click here for github)",
    description:
  ...
  {
    name: "LeetCode Solutions (Public - Click here for github)",
    description:
  ...
  {
    name: "Monkeypox Visualizer 🦠 (Public - Click here for github)",
    description:
  ...
  {
    name: "AI SaaS FlashSet 🤖 (Public - Click here for github)",
    description:
  ...
  {
    name: "Android Application 📱 (Public - Click here for github)",
    description:
  ...
  {
    name: "Minimax Algorithm Through Tic-Tac-Toe (Public - Click here for github)",
    description:
